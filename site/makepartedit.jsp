...
success = editor.SaveParts();
if (success) editor.partdata = webrunner.cardmaster.CardmasterData.loadAvatarParts();
} else { %> ERROR: NO TEXT! <% } 

webrunner.cardmaster.CardmasterLogManager.WriteLog(session.getAttribute("loginname") + " edits avatar part data");
%> Edit complete. <br> Success:<%=success%> <br>  If you wish, you can save this file: <a href="avatar.cmc">Avatar.cmc</a><br>

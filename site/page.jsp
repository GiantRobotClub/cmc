...
<ul id="nav">
	<li>General
		<ul>
			...
			<li><a href="http://cmc.mrx.ca:8000/wiki/index.php/Help" onmouseover="image.src='images/circleimage_help.gif';" onmouseout="image.src='images/circleimage_0.gif';">Help</a></li>
			<li><a href="http://cmc.mrx.ca:8000/wiki/index.php/Rules" onmouseover="image.src='images/circleimage_help.gif';" onmouseout="image.src='images/circleimage_0.gif';">Rules</a></li>

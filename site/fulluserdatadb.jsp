...
<% if (true) { 
 ...
 webrunner.cardmaster.CardmasterUser user = webrunner.cardmaster.CardmasterDatabase.LoadUserDB(username); %>
...
ALL DECKS: <% for (int i=0;i<user.decks.length;i++) { %> 
...
LAST LOGGED IN: <%=user.month%>/<%=user.year%><br>

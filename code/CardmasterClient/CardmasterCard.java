...
public class CardmasterCard extends JPanel {
...
//	String artist = "Mark Shallow";
	...
	CardmasterCard(String name, String cardtext, String picture, String typecode, String targetmtype,
	...
	CardmasterCard(String name, String cardtext, String picture, String typecode,
		 int cardid, int expansioncode, int colorcode, int Dcost, int Lcost, int Gcost){	
	...
	void copydata(CardmasterCard card) {
...
//			System.out.println("Draw Large: " + drawlarge);
			if (drawlarge) { // Big Version // assumes 100x140
				...
				g2.setColor(text);
				Font f = manager.getFont("lf");
				Font f2 = manager.getFont("lf2");
				Font f3 = manager.getFont("lf3");
				g2.setFont(f);
				...
				if(!(typecode.equals("s")) && !(typecode.equals("l")) && !(typecode.startsWith("d"))) {
		...
		//		g2.drawString("cost: " + Dcost + "D " + Lcost + "L " + Gcost + "G",hspace,fontsize1);
			...
			if (!extendedart) {
				...
				if (typecode.startsWith("d")) {
					...
					String tostring = "";
					if (typecode.equals("dm")) {
						tostring = " to monster";
					}
					else if (typecode.equals("de")) {
						tostring = " to effect";
						
					}
					else if (typecode.equals("db")) {
						tostring = " to entity";
					}
					g2.drawString("Attach " + (unique ? "unique " : "" )+ mtypeline  + tostring,hspace,vspace + fontsize1*3 + vspace+(int)((double)(getWidth()-3) / imageratio) + fontsize2); }
		...
		String returnstring = cardid + "#"  + name  + "#" +  speed + "#" + background + "#" +typecode +"#" + Dcost+ "#" + Lcost+ "#" + Gcost+
		 ...
		 if (typecode.equals("e") || typecode.equals("m") || typecode.equals("s") || typecode.startsWith("d")) returnstring = returnstring +  bToI(targete)+ "#" + bToI(targetp)+ "#" + bToI(targets)+ "#" + bToI(targetm)+ "#" + bToI(targeta)+ "#" + bToI(targetg)+ "#" + targetmtype + "#";
		 ...
		 if (typecode.equals("e") || typecode.equals("m") || typecode.startsWith("d")) {
		 	...
		 	if (typecode.equals("m") || typecode.equals("e") || typecode.startsWith("d")) returnstring = returnstring + mtype + "#";

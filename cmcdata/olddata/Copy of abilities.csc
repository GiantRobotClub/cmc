...
12#NCODE;#NCODE;#NCODE;#NCODE;#NCODE;#NCODE;#NCODE;#START;L-SET^slf^sm^none^none^mlp:slf:sm:none:none:0.5:^;MAKMS^12^t^map:slf:sm:none:none:1:^mlp:slf:sm:none:none:1:^;END;#
...
18#START;COUNT^all^bm^slime^none^;A-SET^slf^sm^none^none^cnt:15:^;END;#NCODE;#NCODE;#NCODE;#NCODE;#NCODE;#NCODE;#NCODE;#
...
26#NCODE;#NCODE;#NCODE;#NCODE;#NCODE;#NCODE;#NCODE;#START;DAMAG^trg^bm^none^none^30^;END;#
...
33#NCODE;#START;COSTG^4^;REQ;RETRN;END;#NCODE;#NCODE;#NCODE;#NCODE;#NCODE;#START;DAMAG^trg^bm^none^none^40^;END;#
...
91#NCODE;#TCMB*;AMODF^all^bm^bird^none^5^;LMODF^all^bm^bird^none^5^;END;#NCODE;#NCODE;#NCODE;#NCODE;#NCODE;#NCODE;#
